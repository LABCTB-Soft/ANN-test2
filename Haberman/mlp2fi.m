clear all
close all
load D:\programs\paper5\mfiles\Haberman\train.mat 
[m,n]=size(train);
iu=train(:,1:3);
ytf=train(:,4:5);
[k,h]=size(ytf);
...
N2=12;% number of first hidden layer
N3=17;% number of second hidden layer
...
%averror=10000*eav
if rem(p,10)==0
   save D:\programs\paper5\mfiles\Haberman\mlp2haber.mat wf1 wf2 wf3 s p iu ytf yfh N1 N2 N3 N4 n;
end
if eav<=1e-4
   break;
end
